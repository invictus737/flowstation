...
use tetra_core::{BitBuffer, Layer2Service, SsiType, TetraAddress};
    ...
    fn do_control_command(
        ...
        match cmd {
            ...
            ControlCommand::RestartService => {
                tracing::warn!("CMCE: RestartService ignored; no configured service unit allowlist");
            }
            ControlCommand::ShutdownService => {
                tracing::warn!("CMCE: ShutdownService ignored; no configured service unit allowlist");
            }
            _ => {
                    ...
                    queue.push_back(SapMsg {
                        ...
                        msg: SapMsgInner::LcmcMleUnitdataReq(LcmcMleUnitdataReq {
                            ...
                            main_address: TetraAddress {
                                ssi: prim.received_tetra_address.ssi,
